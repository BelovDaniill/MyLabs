...
# Вывод
Целью данной лабораторной работы было анализ и составление HTTP запросов. В ходе лабораторной работе были составлены некоторые типы запросов, такие как GET и POST. Также был предложен вариант ответа сервера на предоставленный запрос.  
